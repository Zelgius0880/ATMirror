...
class SHT21(i2cName: String, address: Int = 0x60) {
    ...
    fun calcRH(buffer: ByteBuffer): Float {
        ...
        val sRH = buffer.getShort(0).toUShort().toInt()//.toFloat()
    ...
    fun softReset() {
        try {
            ...
            Log.e("SoftReset failed with an IOException: ", exception.message?:"no message")
        }
        delay(50)
    }
    ...
    fun getEndOfBatteryAlert(): EndOfBatteryAlert? {
        ...
        try {
            ...
            Log.e("getEOBAlert() failed.", exception.message?:"no message")
        }
        return null
    }
    ...
    fun getHeaterStatus(): HeaterStatus? {
        ...
        try {
            ...
            Log.e("Getting heater status failed. IOException: ", exception.message?:"no message")
        }
        return null
    }
    ...
    private fun measurePollHumidity(): Float {
        ...
        try {
            ...
            Log.e("Humidity measurement failed because of an IOException: ", exception.message?:"no message")
            return Float.MIN_VALUE
        }
    }
