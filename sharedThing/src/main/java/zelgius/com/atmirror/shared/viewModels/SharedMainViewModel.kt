package zelgius.com.atmirror.shared.viewModels
...
import zelgius.com.atmirror.shared.repositories.DatabaseRepository
...
open class SharedMainViewModel(private val context: Application) : AndroidViewModel(context) {
    ...
    val lastKnownRecord = zelgius.com.atmirror.shared.entities.SensorRecord()

    val history = MutableLiveData<List<zelgius.com.atmirror.shared.entities.SensorRecord>>()
    ...
    val sht21Record = MutableLiveData<zelgius.com.atmirror.shared.entities.SensorRecord>()
    ...
    open fun updateLastKnownRecord(data: zelgius.com.atmirror.shared.entities.SensorRecord): Boolean {
