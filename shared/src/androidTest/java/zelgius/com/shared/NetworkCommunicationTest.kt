...
import zelgius.com.shared.viewModels.MirrorNetworkViewModel
import zelgius.com.shared.viewModels.PhoneNetworkViewModel
...
class NetworkCommunicationTest {
    ...
    private val phoneViewModel = PhoneNetworkViewModel(context)
    private val mirrorViewModel = MirrorNetworkViewModel(context)
