...
class FloatingActionMenu : FloatingActionButton {
    ...
    private fun openMenu() {
        ...
        if (animation == null) {
            animator = animate().rotationBy(rotationAnimation).setListener(object : Animator.AnimatorListener {
    ...
    private fun closeMenu() {
        ...
        if (animation == null) {
            animate().rotationBy(-rotationAnimation).setListener(object : Animator.AnimatorListener {
                override fun onAnimationRepeat(animation: Animator?) {
